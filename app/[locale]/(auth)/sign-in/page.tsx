        ...
        <div className="booking-bg relative w-115.75 h-132.25 px-13.5 pb-16.25 pt-25 rounded-[31px]">
          ...
          {isLoading ? (<Loading/>) : (
            <form autoComplete="off" onSubmit={hendleSubmit} className="flex items-center flex-col">
              <Input name="username" extraStyle="text-[16px] pl-3 text-[#585858] bg-[#d2d1d1] mb-[30px] border-black" type="text" title="Ваше имя пользователя"/>
              <label>
                <Input name="password" extraStyle="text-[16px] pl-3 text-[#585858] mb-[8px] border-black" type="text" title="password"/>
                <Link href={"#"} className="text-[12px] text-[#000000]">Забыли пароль?</Link>
              </label>
              <Button type="submit" title="Вход в аккаунт" extraStyle="mt-8 bg-[#d2d1d1] bg-black mb-2 py-[25px] px-[25px] text-[18px] text-[#FFFFFF] flex items-center gap-2 rounded-[13px]"/>
